...
class ProdutosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create produto" do
    assert_difference('Produto.count') do
      post produtos_url, params: { produto: { categoria: @produto.categoria, descricao: @produto.descricao, imagem: @produto.imagem, qtdunit: @produto.qtdunit, valorunit: @produto.valorunit, volume: @produto.volume } }
    end
  ...
  test "should update produto" do
    patch produto_url(@produto), params: { produto: { categoria: @produto.categoria, descricao: @produto.descricao, imagem: @produto.imagem, qtdunit: @produto.qtdunit, valorunit: @produto.valorunit, volume: @produto.volume } }
